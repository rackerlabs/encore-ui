...
/**
 * Functionality around a single tag object.
 */
export class Tag extends rxComponentElement {
    ...
    /**
     * Removes the tag by clicking on it, then sending the backspace key.
     *
     * @example
     *
    ...
    /**
     * The text within the tag. Does not include the text in [[Tag.getCategory]].
     *
     * @example
     *
    ...
    /**
     * The category text of a tag. This appears in parentheses, after the normal text.
     *
     * @example
     *
    ...
    /**
     * Close the tag by clicking the little "x" button on the right side of the tag.
     *
     * @example
     *
...
/**
 * Functions for interacting with a group of existing tags, creating new ones,
 * or deleting existing ones.
 */
export class rxTags extends rxComponentElement {

    /**
     * The number of tags that exist in the group of tags.
     *
     * @example
     *
    ...
    /**
     * Adds a new tag with text `text` to the group of tags.
    ...
    /**
     * Return a [[Tag]] object that matches the `text` passed in.

...
export class rxPaginate extends rxComponentElement {
    ...
    /**
     * Jump to a specific page, navigating backwards or forwards if necessary.
     *
     * @example
     *
    ...
    /**
     * Visit the first page in the paginated table by clicking the "First" link,
    ...
    /**
     * Go back one page from the current position in the table.
     *
     * @example
     *
    ...
    /**
     * Go forward one page from the current position in the table.
     *
     * @example
     *
    ...
    /**
     * Visit the last page in the paginated table by clicking the "Last" link,
    ...
    /**
     * A list of all available page numbers that can be
     ...
     * to the desired page number. Internal function that supports [[rxPaginate.jumpToPage]].
     *
     * @example
     *
    ...
    /**
     * A list of available page sizes that can be queried and adjusted
     * by using [[rxPaginate.getPageSize]].
     *
     * @example
     *
    ...
    /**
     * The current number of visible items on a single page in the table.
     *
     * @example
     *
    ...
    /**
     * Change the number of visible items on a single page in the table.
     *
     * @example
     *
     *     it('should change the page size to make it easier to find things', () => {
